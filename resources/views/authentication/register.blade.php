    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid stepper stepper-pills stepper-column stepper-multistep" id="kt_create_account_stepper">
        ...
        <div class="d-flex flex-column flex-lg-row-auto w-lg-350px w-xl-500px">
            ...
            <div class="d-flex flex-center py-10 py-lg-20 mt-lg-20">
                <!--begin::Logo-->
                <a href="index.html">
                    <img alt="Logo" src="{{ asset('/media/logos/custom-1.png') }}" class="h-70px" />
                </a>
                <!--end::Logo-->
            </div>
            <!--end::Header-->
                    ...
                    <div class="" data-kt-stepper-element="content">
                        ...
                        <div class="w-100">
                            ...
                            <div class="mb-0 fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center form-label mb-5">Choose Your Account Role
                                    <span class="ms-1" data-bs-toggle="tooltip" title="Select what role suits best for your organization">
												<i class="ki-duotone ki-information-5 text-gray-500 fs-6">
													<span class="path1"></span>
													<span class="path2"></span>
													<span class="path3"></span>
                                ...
                                <div class="mb-0">
                                        ...
                                        <span class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Description-->
														<span class="d-flex flex-column">
															...
															<span class="fs-6 fw-semibold text-muted">Empower your team for peak productivity effortlessly.</span>
														</span>
                                            <!--end:Description-->
													</span>
                                        <!--end:Label-->
                                        ...
                                        <span class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Description-->
														<span class="d-flex flex-column">
															...
															<span class="fs-6 fw-semibold text-muted">Boost your coding prowess.</span>
														</span>
                                            <!--end:Description-->
													</span>
                                        <!--end:Label-->
                                    ...
                                    <label class="d-flex flex-stack mb-0 cursor-pointer">
                                        ...
                                        <span class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Description-->
														<span class="d-flex flex-column">
															<span class="fw-bold text-gray-800 text-hover-primary fs-5">Student Account</span>
															<span class="fs-6 fw-semibold text-muted">Gain an advantage among your students</span>
														</span>
                                            <!--end:Description-->
													</span>
                                        <!--end:Label-->
