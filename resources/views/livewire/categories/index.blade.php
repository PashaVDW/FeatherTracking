...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        window.Echo.channel("categories").listen("CompanyCreated", (event) => {
            console.log(event);
        });
    });
</script>
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        @foreach($categories as $category)
            ...
            <div class="col-md-6 col-xl-4">
                <!--begin::Card-->
                <a href="{{ route('') }}" class="card border-hover-primary">
                    <!--begin::Card header-->
                    ...
                    <div class="card-body p-9">
                        <!--begin::Name-->
                        <div class="fs-3 fw-bold text-gray-900">{{ $category['name'] }}</div>
                        <!--end::Name-->
                        <!--begin::Description-->
                        <p class="text-gray-500 fw-semibold fs-5 mt-1 mb-7">{{ $category['description'] }}</p>
                        <!--end::Description-->
                        <!--begin::Info-->
                        <div class="d-flex flex-wrap mb-5">
                            <!--begin::Due-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                <div class="fs-6 text-gray-800 fw-bold">{{ \Carbon\Carbon::parse($category['created_at'])->format('Y-m-d') }}</div>
                                <div class="fw-semibold text-gray-500">Project Created</div>
                            </div>
                            <!--end::Due-->
                            <!--begin::Budget-->
